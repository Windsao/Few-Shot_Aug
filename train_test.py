...
from engine_test import train_one_epoch, evaluate
...
def main(args):
    ...
    data_loader_val = torch.utils.data.DataLoader(
        dataset_val, batch_size=int(16 * args.batch_size),
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats, train_pred, train_true, train_out = train_one_epoch(
            ...
            is_visual_prompt_tuning=args.is_visual_prompt_tuning,is_adapter=args.is_adapter,is_LoRA=args.is_LoRA,is_prefix=args.is_prefix, classes=args.nb_classes, gen_model=gen_model
        )
