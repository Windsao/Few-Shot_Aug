...
def get_args_parser():
    ...
    parser.add_argument('--model', default='', type=str, metavar='MODEL',
                        help='Name of model to train')
    # AutoFormer config
    parser.add_argument('--mode', type=str, default='baseline', choices=['super', 'vp','retrain','search', 'baseline'], help='mode of AutoFormer')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch > 10 and epoch % args.val_interval == 0 or epoch == args.epochs-1:
